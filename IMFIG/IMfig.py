...
def get_popsize_param (f,a,s,numpops) :
    ...
    for i in range(4) :
        aa = f.readline().split()
    for i in range(1,1+(2*numpops - 1)):
        psp.append([])
        psp[i-1].append(aa[i])
    for i in range (numtablerows):
        ...
        if found :
            for i in range(1,1+(2*numpops - 1)):
                psp[i-1].append(float(aa[i].strip('?#')))
    return psp
...
def get_2Nm_alt (f,a,s,numpops) :
    ...
    while True :
        ...
        for i in range(1,len(aa)):
            ...
            ii += 1
        s = f.readline()
        while s.find("Population Migration (2Nm) Terms")==-1 and s.find("HISTOGRAMS")==-1:
            s = f.readline()
        if s.find("HISTOGRAMS")>= 0:
            break;
        nummigp += newn
    return psp
...
##             ["migration parameter info",False,get_2Nm,"POPULATION MIGRATION (2Nm) POSTERIOR PROBABILITY HISTOGRAMS"],\
             ...
             ["parameter priors",False,get_parameter_priors,"Parameter Priors"]]
    ...
    while imfileline != '':
        ...
        for i in range(len(slist)):
            ...
            if slist[i][1] == False and imfileline.find(slist[i][3]) >= 0 :
...
print "IMfig program.  Copyright 2009  Jody Hey "
setdefaults()

##/// command lines used for writing IMfig and for making chimp figs ///////////////
cmdstr ="python IMfig.py  -a  -iPan_4pops_w_names_3_9_09_m1_reload_3_23_09.out -otemp.eps"
##cmdstr = "IMfig.py -s -y1.8  -iPaniscus_PanSchwein_3_9_09_m1_run1_3_16_09.out  -otemp.eps"
##cmdstr = "IMfig.py  -x1.5 -y4 -s -h0.6 -p19  -iPanSchwein_PanTrog_3_9_09_m1_run1_reload_3_16_09.out    -otemp.ps"
cmdstr = "IMfig.py  -x0.3 -y0.6 -s -h0.8 -p20   -iPanSchwein_PanVerus_3_9_09_m1_run1_reload_3_16_09.out -otemp.eps"
cmdstr = "IMfig.py  -fTimes -x0.25 -y0.6 -s -h1.0 -p20  -iPan_troglodytes_3pops_3_9_09_m3_reload_4_8_09.out -oPan_troglodytes_3pops_3_9_09_m3_reload_4_8_09.eps"

cmdstr = "IMfig.py -fTimes -b2 -iPan_4pops_w_names_3_9_09_m1_reload_3_23_09.out -otemp.eps"

cmdstr = "IMfig.py -b2 -iPan_4pops_w_names_3_9_09_5_15_09_m1_reload.out -otemp.eps"

cmdstr = "IMfig.py   -y0.8 -s -h0.8 -p22 -iPanTrog_PanVerus_3_9_09_5_15_09_m1_reload.out -oPanTrog_PanVerus_3_9_09_5_15_09_m1.eps"

cmdstr = "IMfig.py  -iPan_4pops_w_names_3_9_09_5_15_09_m1_reload.out -otemp.eps"
cmdstr = "IMfig.py -fArial -g1.0 -x0.5 -s -a -c -ma -b3 -iPan_4pops_w_names_3_9_09_7_13_09_m5_reload.out -otemp.eps"
##cmdstr = "IMfig.py -fHelvetica -ma -s -b1.5 -h0.8 -p20 -iPaniscus_PanSchwein_3_9_09_5_15_09_m1_reload.out -otemp.eps"

cmdstr = "IMfig.py -fHelvetica -ma -s -b1.5 -x1.5 -h0.8 -p20 -iPan_troglodytes_3pops_3_9_09_5_15_09_m1_reload.out -otemp.eps"

cmdstr = "IMfig.py -ms -b2   -iPan_4pops_w_names_3_9_09_5_15_09_m1_reload_8_30_09.out   -oPan_4pops_w_names_3_9_09_5_15_09_m1_reload_8_30_09.eps"
cmdstr = "IMfig.py -ms -b2   -iPan_4pops_w_names_3_9_09_j7_m05_reload_8_30_09.out	-oPan_4pops_w_names_3_9_09_j7_m05_reload_8_30_09.eps      "
cmdstr = "IMfig.py -ms -b2   -iPan_4pops_w_names_3_9_09_7_13_09_m5_reload_8_30_09.out	-oPan_4pops_w_names_3_9_09_7_13_09_m5_reload_8_30_09.eps  "
cmdstr = "IMfig.py -itrogtrog_verus_48loci_WonHey05_forIMa2_run1.out -otrogtrog_verus_48loci_WonHey05_forIMa2_run1.eps"
cmdstr = ""
##//////////// identify if program is run within interpreter, or from command line ///////////
##print "scan commandline"
if len(sys.argv)<=1 : ## use this so can run in IDLE and in cmd window
